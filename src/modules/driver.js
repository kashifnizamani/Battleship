import { DOMboard } from "./DOMController";
...
human.board.placeShip(new Ship(5), 0, 0, "horizontal"); // Carrier
human.board.placeShip(new Ship(4), 2, 2, "vertical");   // Battleship
human.board.placeShip(new Ship(3), 5, 5, "horizontal"); // Cruiser
human.board.placeShip(new Ship(3), 7, 1, "vertical");   // Submarine
human.board.placeShip(new Ship(2), 9, 7, "vertical");   // Destroyer
